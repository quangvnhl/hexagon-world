...
ARG NEXT_PUBLIC_ADSGRAM_REWARDED_LOBBY_RANDOM_BLOCK_ID=
ENV NEXT_PUBLIC_ADSGRAM_REWARDED_LOBBY_RANDOM_BLOCK_ID=$NEXT_PUBLIC_ADSGRAM_REWARDED_LOBBY_RANDOM_BLOCK_ID
ARG NEXT_PUBLIC_ADSGRAM_INTERSTITIAL_END_GAME_BLOCK_ID=
ENV NEXT_PUBLIC_ADSGRAM_INTERSTITIAL_END_GAME_BLOCK_ID=$NEXT_PUBLIC_ADSGRAM_INTERSTITIAL_END_GAME_BLOCK_ID
