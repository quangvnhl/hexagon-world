...
export type S2CControl = {
    ...
    t: "revive_result";
    ok: boolean;
    reason?: "no_spawn" | "king_locked" | "not_dead";
} | {
    t: "event";
    kind: "death";
    id: number;
...
export declare function encodeMatchConfig(config: MatchConfig): string;
/** Parse chuỗi JSON `MatchConfig` từ welcome; trả `null` nếu hỏng/không phải object. */
export declare function decodeMatchConfig(s: string): MatchConfig | null;
