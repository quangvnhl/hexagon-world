...
class GameState {
    constructor(spawnAt, botCount = config_1.CONFIG.BOT_COUNT, humanCount = 1) {
        ...
        this.map = (0, arena_1.mapArena)(config_1.CONFIG.MAP_MARGIN);
    ...
    pickSpawnHex(e) {
        ...
        const lim = arena_1.ARENA_INRADIUS - inset; // biên lấy mẫu (đủ sâu để cụm khởi đầu lọt trong)
        ...
        const clearAround = (c) => {
            for (const k of this.cellOwner.keys()) {
                if ((0, hex_1.cubeDistance)(keyToAxial(k), c) <= clearance)
                    return false;
            }
            return true;
        };
    ...
    updateEntity(e, dt) {
        ...
        const maxTurn = config_1.CONFIG.TURN_RATE * dt;
        ...
        const c = (0, arena_1.clampInside)(e.pos.x + vx * dist, e.pos.y + vy * dist);
        ...
        if (moved > 1e-7) {
            ...
            const intoOwnTrail = this.cellTrail.get((0, hex_1.keyOf)((0, hex_1.pixelToAxial)(c.x, c.y, config_1.CONFIG.HEX_SIZE))) === e.id;
    ...
    steerAvoiding(e, desired, skill) {
        const dist = config_1.CONFIG.BOT.AVOID_DIST * (0.7 + skill * 0.8);
