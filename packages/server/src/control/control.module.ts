...
@Module({
  controllers: [AdminController, AnalyticsController, AuthController, CampaignController, DailyController, DevAuthController, EnergyController, LeaderboardController, LevelRewardsController, GoogleOAuthController, TelegramAuthController, MatchesController, TelegramPaymentsController, PlayersController, QuestsController, RegionsController, RemoteConfigController, ShopController],
